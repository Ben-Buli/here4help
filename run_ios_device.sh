...
#   ./run_ios_device.sh "Mook" debug   # 指定真機，模式=debug
#   ./run_ios_device.sh "Mook" profile # 指定真機，模式=profile
#   ./run_ios_device.sh "Mook" release # 指定真機，模式=release
#   ./run_ios_device.sh "Mook" attach  # 連接到已運行的應用程式
