...
class _PermissionDeniedPageState extends State<PermissionDeniedPage> {
  ...
  void _returnToBlockedPage(BuildContext context) {
    ...
    debugPrint('🔍 [PermissionDenied] 當前 URL: ${state.uri}');
    debugPrint('🔍 [PermissionDenied] 查詢參數: ${state.uri.queryParameters}');
    debugPrint('🔙 [PermissionDenied] blocked 參數: $blockedPath');
    debugPrint('🔙 [PermissionDenied] from 參數: $fromPath');
